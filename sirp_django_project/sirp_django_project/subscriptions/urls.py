...
urlpatterns = [
    ...
    path("subscriptions/<uuid:pk>/pause/", views.SubscriptionPauseView.as_view(), name="subscription-pause"),
    path("subscriptions/<uuid:pk>/resume/", views.SubscriptionResumeView.as_view(), name="subscription-resume"),
